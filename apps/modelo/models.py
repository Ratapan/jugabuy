...
class Region(models.Model):
    ...
    desc_reg = models.CharField(max_length=40, null=False, blank=False)
...
class Usuario(models.Model):
    ...
    us_mail  = models.EmailField(null=False, blank=False)
    us_nom   = models.CharField(max_length=20, null=False, blank=False)
    us_apes  = models.CharField(max_length=40, null=False, blank=False)
    us_contr = models.CharField(max_length=20, null=False, blank=False)
    us_nac   = models.DateField(null=False, blank=False)
    us_creac = models.DateField(null=False, blank=False)
    us_tel   = models.IntegerField(null=False, blank=False)
    us_dir   = models.CharField(max_length= 50, null=False, blank=False)
    us_sald  = models.IntegerField(null=False, blank=False)
    id_rol   = models.ForeignKey(Rol,null=False,blank=False,on_delete =models.DO_NOTHING)
    id_ciud  = models.ForeignKey(Ciudad,null=False,blank=False,on_delete =models.DO_NOTHING)
